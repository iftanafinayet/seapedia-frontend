...
import { ShoppingBag, Truck, Check, Circle, MapPin, CreditCard, ClipboardList } from 'lucide-react';
import Card from '../../components/ui/Card';
import Skeleton from '../../components/ui/Skeleton';
import Button from '../../components/ui/Button';
import { getSellerOrder, processOrder } from '../../api/seller';
...
export default function SellerOrderDetailPage() {
  ...
  const isPacking = order.status === 'SedangDikemas' || order.status === 'Sedang_Dikemas';
  ...
  return (
    <div className="space-y-5 pb-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
        ...
        <span className={cn('self-start inline-flex items-center px-3 py-1 rounded-full text-[12px] font-semibold', badge.className)}>
          {badge.label} · #{order.id}
        </span>
      </div>
